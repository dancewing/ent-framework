...
public final class HrPositionDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(positionId, positionName, positionCode, positionSort, statusFlag, positionRemark, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
