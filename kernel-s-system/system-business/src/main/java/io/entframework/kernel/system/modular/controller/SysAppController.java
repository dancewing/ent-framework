...
public class SysAppController {
    ...
    public ResponseData<Void> updateStatus(@RequestBody @Validated(BaseRequest.updateStatus.class) SysAppRequest sysAppParam) {
    ...
    public ResponseData<Void> setAsDefault(@RequestBody @Validated(SysAppRequest.updateActiveFlag.class) SysAppRequest sysAppParam) {
