...
public final class SysAppDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(appId, appName, appCode, entryPath, appIcon, activeFlag, statusFlag, appSort, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
