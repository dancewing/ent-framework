...
public final class HrOrganizationDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(orgId, orgParentId, orgPids, orgName, orgCode, orgSort, statusFlag, orgRemark, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
