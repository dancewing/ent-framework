...
public class SysUserController {
    ...
    public ResponseData<Void> batchDelete(@RequestBody @Validated(BaseRequest.batchDelete.class) SysUserRequest sysUserRequest) {
    ...
    public ResponseData<Void> updateStatus(@RequestBody @Validated(SysUserRequest.changeStatus.class) SysUserRequest sysUserRequest) {
    ...
    public ResponseData<Void> resetPwd(@RequestBody @Validated(SysUserRequest.resetPwd.class) SysUserRequest sysUserRequest) {
    ...
    public ResponseData<Void> grantRole(@RequestBody @Validated(SysUserRequest.grantRole.class) SysUserRequest sysUserRequest) {
    ...
    public ResponseData<Void> grantData(@RequestBody @Validated(SysUserRequest.grantData.class) SysUserRequest sysUserRequest) {
     ...
     **/
    @GetResource(name = "运维平台接口检测", path = "/sys-user/devops-api-check", requiredLogin = false, requiredPermission = false)
