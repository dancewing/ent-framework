...
public final class SysRoleDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(roleId, roleName, roleCode, roleSort, dataScopeType, statusFlag, remark, delFlag, createTime, createUser, updateTime, updateUser, roleSystemFlag, roleTypeCode, createUserName, updateUserName);
