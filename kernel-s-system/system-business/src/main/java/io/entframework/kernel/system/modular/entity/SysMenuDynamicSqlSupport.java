...
public final class SysMenuDynamicSqlSupport {
	...
	public static final BasicColumn[] selectList = BasicColumn.columnList(menuId, menuParentId, menuPids, menuName,
			menuType, menuCode, appId, menuSort, statusFlag, remark, router, icon, linkOpenType, linkUrl, activeUrl,
			visible, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
