...
public final class SysMenuResourceDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(menuResourceId, menuId, resourceCode, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
