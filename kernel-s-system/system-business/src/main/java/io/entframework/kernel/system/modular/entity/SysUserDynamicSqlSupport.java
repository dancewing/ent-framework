...
public final class SysUserDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(userId, realName, nickName, account, password, avatar, birthday, sex, email, phone, tel, superAdminFlag, orgId, positionId, statusFlag, loginCount, lastLoginIp, lastLoginTime, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
