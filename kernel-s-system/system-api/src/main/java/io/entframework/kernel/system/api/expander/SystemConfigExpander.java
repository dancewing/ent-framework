...
public class SystemConfigExpander {
    ...
    public static String getReleaseVersion() {
        return ConfigContext.me().getSysConfigValueWithDefault("SYS_RELEASE_VERSION", String.class,
                SystemConstants.DEFAULT_SYSTEM_VERSION);
    }
    ...
    public static Boolean getTenantOpen() {
        return ConfigContext.me().getSysConfigValueWithDefault("SYS_TENANT_OPEN", Boolean.class,
                SystemConstants.DEFAULT_TENANT_OPEN);
    }
    ...
    public static String getSystemName() {
        return ConfigContext.me().getSysConfigValueWithDefault("SYS_SYSTEM_NAME", String.class,
                SystemConstants.DEFAULT_SYSTEM_NAME);
    }
    ...
    public static String getDefaultPassWord() {
        return ConfigContext.me().getSysConfigValueWithDefault("SYS_DEFAULT_PASSWORD", String.class,
    ...
    public static boolean getDevSwitchStatus() {
        Boolean result = ConfigContext.me().getSysConfigValueWithDefault("DEVOPS_DEV_SWITCH_STATUS", Boolean.class,
                Boolean.FALSE);
        if (result != null) {
            return result;
        }
