...
public class SysAppRequest extends BaseRequest {
    ...
    @NotNull(message = "appId不能为空",
            groups = { update.class, delete.class, detail.class, updateActiveFlag.class, updateStatus.class })
    ...
    @TableUniqueValue(message = "名称存在重复", groups = { add.class, update.class }, tableName = "sys_app",
            columnName = "app_name", idFieldName = "app_id", excludeLogicDeleteItems = true)
    ...
    @TableUniqueValue(message = "编码存在重复", groups = { add.class, update.class }, tableName = "sys_app",
            columnName = "app_code", idFieldName = "app_id", excludeLogicDeleteItems = true)
    ...
    @NotBlank(message = "编码不能为空", groups = { add.class, update.class })
    @TableUniqueValue(message = "编码存在重复", groups = { add.class, update.class }, tableName = "sys_app",
            columnName = "entry_path", idFieldName = "app_id", excludeLogicDeleteItems = true)
