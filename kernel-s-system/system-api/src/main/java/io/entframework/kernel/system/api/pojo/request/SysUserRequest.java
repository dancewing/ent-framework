...
public class SysUserRequest extends BaseRequest {
     ...
     * 主键
     */
    @NotNull(message = "userId不能为空", groups = {update.class, delete.class, detail.class, grantRole.class, grantData.class, resetPwd.class, changeStatus.class})
    ...
    @TableUniqueValue(
            message = "账号存在重复",
            groups = {add.class, update.class, reg.class},
            tableName = "sys_user",
            columnName = "account",
            idFieldName = "user_id",
