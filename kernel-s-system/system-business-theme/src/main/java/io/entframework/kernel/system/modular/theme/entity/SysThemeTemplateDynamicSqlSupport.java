...
public final class SysThemeTemplateDynamicSqlSupport {
	...
	public static final BasicColumn[] selectList = BasicColumn.columnList(templateId, templateName, templateCode,
			templateType, statusFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
