...
public final class SysThemeTemplateFieldDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(fieldId, fieldName, fieldCode, fieldType, fieldRequired, fieldLength, fieldDescription, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
