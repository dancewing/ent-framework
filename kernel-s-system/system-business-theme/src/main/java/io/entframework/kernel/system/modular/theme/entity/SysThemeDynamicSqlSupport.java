...
public final class SysThemeDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(themeId, themeName, templateId, statusFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName, themeValue);
