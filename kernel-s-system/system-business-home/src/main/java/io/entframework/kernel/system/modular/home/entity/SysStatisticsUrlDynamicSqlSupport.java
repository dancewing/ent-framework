...
public final class SysStatisticsUrlDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(statUrlId, statName, statMenuId, statUrl,
            alwaysShow, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
