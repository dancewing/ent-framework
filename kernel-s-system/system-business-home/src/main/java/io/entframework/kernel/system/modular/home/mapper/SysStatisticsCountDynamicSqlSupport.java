...
public final class SysStatisticsCountDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(statCountId, userId, statUrlId, statCount, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
