...
public final class SysNoticeDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(noticeId, noticeTitle, noticeSummary,
            noticeContent, priorityLevel, noticeBeginTime, noticeEndTime, noticeScope, delFlag, createUser, createTime,
            updateUser, updateTime, createUserName, updateUserName);
