 ...
 */
@Slf4j
public class SysNoticeServiceImpl extends BaseServiceImpl<SysNoticeRequest, SysNoticeResponse, SysNotice>
	...
	private SysNotice querySysNoticeById(SysNoticeRequest sysNoticeRequest) {
		Optional<SysNotice> sysNotice = this.getRepository().selectByPrimaryKey(getEntityClass(),
				sysNoticeRequest.getNoticeId());
