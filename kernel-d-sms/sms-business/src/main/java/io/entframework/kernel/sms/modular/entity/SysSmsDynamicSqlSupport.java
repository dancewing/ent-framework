...
public final class SysSmsDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(smsId, phoneNumber, validateCode,
            templateCode, bizId, statusFlag, source, invalidTime, createTime, createUser, updateTime, updateUser,
