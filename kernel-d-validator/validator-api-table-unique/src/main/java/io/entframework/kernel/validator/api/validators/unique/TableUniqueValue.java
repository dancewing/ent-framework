...
public @interface TableUniqueValue {
	 ...
	 * 逻辑删除的字段名称
	 */
	String logicDeleteFieldName() default ValidatorConstants.DEFAULT_LOGIC_DELETE_FIELD_NAME;

	/**
	 * 默认逻辑删除的值（Y是已删除）
	 */
	String logicDeleteValue() default ValidatorConstants.DEFAULT_LOGIC_DELETE_FIELD_VALUE;
