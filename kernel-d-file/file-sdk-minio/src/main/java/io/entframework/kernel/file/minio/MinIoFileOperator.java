...
public class MinIoFileOperator implements FileOperatorApi {
    ...
    public String getFileAuthUrl(String bucketName, String key, Long timeoutMillis, String token) {
        return fileServerProperties.getDeployHost() + contextPath + FileConstants.FILE_PREVIEW_BY_OBJECT_NAME + "?fileBucket=" + bucketName + "&fileObjectName=" + key + "&token=" + token;
    }

    @Override
    public String getFileUnAuthUrl(String bucketName, String key) {
        return fileServerProperties.getDeployHost() + contextPath + FileConstants.FILE_PREVIEW_BY_OBJECT_NAME + "?fileBucket=" + bucketName + "&fileObjectName=" + key;
    }
