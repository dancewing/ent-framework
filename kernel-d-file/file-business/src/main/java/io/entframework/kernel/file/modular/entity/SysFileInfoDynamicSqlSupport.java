...
public final class SysFileInfoDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(fileId, fileCode, fileVersion, fileStatus, fileLocation, fileBucket, fileOriginName, fileSuffix, fileSizeKb, fileSizeInfo, fileObjectName, filePath, secretFlag, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
