...
public class SysFileController {
    ...
    public ResponseData<SysFileInfoResponse> upload(@RequestPart("file") MultipartFile file, @Validated(BaseRequest.add.class) SysFileInfoRequest sysFileInfoRequest) {
     ...
     * @date 2020/12/27 13:17
     */
    @GetResource(name = "公有文件下载", path = "/sys-file-info/public-download", requiredLogin = false, requiredPermission = false)
    ...
    public ResponseData<SysFileInfoResponse> update(@RequestPart("file") MultipartFile file, @Validated(BaseRequest.update.class) SysFileInfoRequest sysFileInfoRequest) {
     ...
     * @date 2020/12/27 13:17
     */
    @GetResource(name = "根据附件IDS查询附件信息", path = "/sys-file-info/get-file-info-list-by-file-ids", requiredPermission = false)
     ...
     * @date 2020/12/27 13:17
     */
    @GetResource(name = "公有打包下载文件", path = "/sys-file-info/public-packaging-download", requiredPermission = false, requiredLogin = false)
    ...
    public ResponseData<Void> deleteReally(@RequestBody @Validated(BaseRequest.delete.class) SysFileInfoRequest sysFileInfoRequest) {
    ...
    public ResponseData<SysFileInfo> detail(@Validated(BaseRequest.detail.class) SysFileInfoRequest sysFileInfoRequest) {
