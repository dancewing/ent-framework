...
class AnimalDataTest {
	...
	void testSelectAllRowsWithOrder() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			AnimalDataMapper mapper = sqlSession.getMapper(AnimalDataMapper.class);
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.orderBy(id.descending()).build().render(RenderingStrategies.MYBATIS3);
			List<AnimalData> animals = mapper.selectMany(selectStatement);
			assertAll(() -> assertThat(animals).hasSize(65), () -> assertThat(animals.get(0).getId()).isEqualTo(65));
		}
	}
		...
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select * from AnimalData order by id DESC"),
					() -> assertThat(animals).hasSize(65), () -> assertThat(animals.get(0)).containsEntry("ID", 65),
	...
	void testSelectAllRowsAllColumnsWithOrder() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select * from AnimalData order by id DESC"),
					() -> assertThat(animals).hasSize(65), () -> assertThat(animals.get(0).getId()).isEqualTo(65));
		}
	}
	...
	void testSelectAllRowsAllColumnsWithOrderAndAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			AnimalDataMapper mapper = sqlSession.getMapper(AnimalDataMapper.class);
			SelectStatementProvider selectStatement = select(animalData.allColumns()).from(animalData, "ad")
					.orderBy(id.descending()).build().render(RenderingStrategies.MYBATIS3);
			List<AnimalData> animals = mapper.selectMany(selectStatement);
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select ad.* from AnimalData ad order by id DESC"),
					() -> assertThat(animals).hasSize(65), () -> assertThat(animals.get(0).getId()).isEqualTo(65));
		}
	}
	...
	void testSelectRowsLessThan20() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isLessThan(20)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectRowsBetween30And40() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isBetween(30).and(40)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectRowsNotBetween() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isNotBetween(10).and(60)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectRowsNotBetweenWithNewNot() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(not(id, isBetween(10).and(60))).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectRowsNotBetweenWithNotGroup() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(not(id, isBetween(10).and(60), or(animalName, isEqualTo("Little brown bat")))).build()
	...
	void testSelectRowsNotBetweenWithNotAndGroup() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(not(group(id, isBetween(10).and(60), or(animalName, isEqualTo("Little brown bat"))))).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testSelectRowsNotBetweenWithStandaloneWhereClause() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			Optional<WhereClauseProvider> whereClause = where(id, isNotBetween(10).and(60)).or(id, isIn(25, 27)).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testComplexConditionWithStandaloneWhereAndTableAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			Optional<WhereClauseProvider> whereClause = where(id, isEqualTo(1), or(bodyWeight, isGreaterThan(1.0)))
					.build().render(RenderingStrategies.MYBATIS3, ExplicitTableAliasCalculator.of(animalData, "a"));

			assertThat(whereClause).hasValueSatisfying(wc -> {
				assertThat(wc.getWhereClause()).isEqualTo(
						"where (a.id = #{parameters.p1,jdbcType=INTEGER} or a.body_weight > #{parameters.p2,jdbcType=DOUBLE})");
	...
	void testSelectRowsNotBetweenWithStandaloneWhereClauseLimitAndOffset() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			Optional<WhereClauseProvider> whereClause = where(id, isLessThan(60)).build()
	...
	void testSelectRowsNotBetweenWithStandaloneWhereClauseAliasLimitAndOffset() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			Optional<WhereClauseProvider> whereClause = where(id, isLessThan(60)).build().render(
					RenderingStrategies.MYBATIS3, ExplicitTableAliasCalculator.of(animalData, "b"),
					"whereClauseProvider");
	...
	void testUnionSelectWithWhere() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isLessThan(20)).union().select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isGreaterThan(40)).build().render(RenderingStrategies.MYBATIS3);

			String expected = "select id, animal_name, body_weight, brain_weight " + "from AnimalData "
					+ "where id < #{parameters.p1,jdbcType=INTEGER} " + "union "
					+ "select id, animal_name, body_weight, brain_weight " + "from AnimalData "
					+ "where id > #{parameters.p2,jdbcType=INTEGER}";

			List<AnimalData> animals = mapper.selectMany(selectStatement);
			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(expected),
					() -> assertThat(animals).hasSize(44), () -> assertThat(selectStatement.getParameters()).hasSize(2),
	...
	void testUnionSelectWithoutWhere() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.union().selectDistinct(id, animalName, bodyWeight, brainWeight).from(animalData).orderBy(id)
					.build().render(RenderingStrategies.MYBATIS3);

			String expected = "select id, animal_name, body_weight, brain_weight " + "from AnimalData " + "union "
					+ "select distinct id, animal_name, body_weight, brain_weight " + "from AnimalData "
					+ "order by id";

			List<AnimalData> animals = mapper.selectMany(selectStatement);
			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(expected),
					() -> assertThat(animals).hasSize(65), () -> assertThat(selectStatement.getParameters()).isEmpty());
		}
	}
	...
	void testUnionAllSelectWithoutWhere() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.unionAll().selectDistinct(id, animalName, bodyWeight, brainWeight).from(animalData).orderBy(id)
					.build().render(RenderingStrategies.MYBATIS3);

			String expected = "select id, animal_name, body_weight, brain_weight " + "from AnimalData " + "union all "
					+ "select distinct id, animal_name, body_weight, brain_weight " + "from AnimalData "
					+ "order by id";
	...
	void testUnionSelectWithTableAliases() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a").where(id, isLessThan(20)).union()
					.select(id, animalName, bodyWeight, brainWeight).from(animalData, "b").where(id, isGreaterThan(40))
					.orderBy(id).build().render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id, a.animal_name, a.body_weight, a.brain_weight " + "from AnimalData a "
					+ "where a.id < #{parameters.p1,jdbcType=INTEGER} " + "union "
					+ "select b.id, b.animal_name, b.body_weight, b.brain_weight " + "from AnimalData b "
					+ "where b.id > #{parameters.p2,jdbcType=INTEGER} " + "order by id";
	...
	void testUnionAllSelectWithTableAliases() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a").where(id, isLessThan(20)).unionAll()
					.select(id, animalName, bodyWeight, brainWeight).from(animalData, "b").where(id, isGreaterThan(40))
					.orderBy(id).build().render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id, a.animal_name, a.body_weight, a.brain_weight " + "from AnimalData a "
					+ "where a.id < #{parameters.p1,jdbcType=INTEGER} " + "union all "
					+ "select b.id, b.animal_name, b.body_weight, b.brain_weight " + "from AnimalData b "
					+ "where b.id > #{parameters.p2,jdbcType=INTEGER} " + "order by id";
	...
	void testUnionSelectWithTableAndColumnAliases() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id.as("animalId"), animalName, bodyWeight, brainWeight)
					.from(animalData, "a").where(id, isLessThan(20)).union()
					.select(id.as("animalId"), animalName, bodyWeight, brainWeight).from(animalData, "b")
					.where(id, isGreaterThan(40)).orderBy(sortColumn("animalId")).build()
					.render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id as animalId, a.animal_name, a.body_weight, a.brain_weight "
					+ "from AnimalData a " + "where a.id < #{parameters.p1,jdbcType=INTEGER} " + "union "
					+ "select b.id as animalId, b.animal_name, b.body_weight, b.brain_weight " + "from AnimalData b "
					+ "where b.id > #{parameters.p2,jdbcType=INTEGER} " + "order by animalId";
	...
	void testIsEqualCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isEqualTo(5)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testIsNotEqualCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isNotEqualTo(5)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testIsGreaterThanOrEqualToCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isGreaterThanOrEqualTo(60)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testIsLessThanOrEqualToCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isLessThanOrEqualTo(10)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testInCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isIn(5, 8, 10)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testInConditionWithEventuallyEmptyListForceRendering() {
		...
		SelectModel selectModel = select(id, animalName, bodyWeight, brainWeight).from(animalData)
				.where(id, isInRequired(inValues).filter(Objects::nonNull).filter(i -> i != 22)).build();

		assertThatExceptionOfType(RuntimeException.class)
				.isThrownBy(() -> selectModel.render(RenderingStrategies.MYBATIS3)).withMessage("Fred");
	}

	@Test
	void testInConditionWithEmptyList() {
		SelectModel selectModel = select(id, animalName, bodyWeight, brainWeight).from(animalData)
				.where(id, isInRequired(Collections.emptyList())).build();
	...
	void testInCaseSensitiveCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isInCaseInsensitive("yellow-bellied marmot", "verbet", null)).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testNotInCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isNotIn(5, 8, 10)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testNotInCaseSensitiveCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isNotInCaseInsensitive("yellow-bellied marmot", "verbet")).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testNotInCaseSensitiveConditionWithNull() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isNotInCaseInsensitive((String) null)).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testNotInConditionWithEventuallyEmptyListForceRendering() {
		SelectModel selectModel = select(id, animalName, bodyWeight, brainWeight).from(animalData)
				.where(id, isNotInRequired(null, 22, null).filter(Objects::nonNull).filter(i -> i != 22)).build();
	...
	void testLikeCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isLike("%squirrel")).build().render(RenderingStrategies.MYBATIS3);
	...
	void testLikeCaseInsensitive() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isLikeCaseInsensitive("%squirrel")).build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> animals = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(animals).hasSize(2),
	...
	void testLikeLowerCase() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, lower(animalName).as("AnimalName"), bodyWeight,
					brainWeight).from(animalData).where(lower(animalName), isLike("%squirrel")).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testLikeUpperCase() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, upper(animalName).as("animalname"), bodyWeight,
					brainWeight).from(animalData).where(upper(animalName), isLike("%SQUIRREL")).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testLength() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, upper(animalName).as("animalname"), bodyWeight,
					brainWeight).from(animalData).where(Length.length(animalName), isGreaterThan(22)).orderBy(id)
							.build().render(RenderingStrategies.MYBATIS3);
	...
	void testNumericConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, constant("3").as("some_number"))
					.from(animalData, "a").where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
					.render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id, a.animal_name, 3 as some_number " + "from AnimalData a "
	...
	void testStringConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			String expected = "select a.id, a.animal_name, 'fred' as some_string " + "from AnimalData a "
					+ "where (a.body_weight + a.brain_weight) > #{parameters.p1,jdbcType=DOUBLE}";
	...
	void testAdd() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					add(bodyWeight, brainWeight).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testAddConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					add(bodyWeight, constant("22"), constant("33")).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testAddConstantWithConstantFirst() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					add(constant("22"), bodyWeight, constant("33")).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testConcatenate() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id,
					concatenate(animalName, stringConstant(" - The Legend")).as("display_name")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id, (a.animal_name || ' - The Legend') as display_name " + "from AnimalData a "
					+ "where (a.body_weight + a.brain_weight) > #{parameters.p1,jdbcType=DOUBLE}";
	...
	void testConcatenateConstantFirst() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id,
					concatenate(stringConstant("Name: "), animalName).as("display_name")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);

			String expected = "select a.id, ('Name: ' || a.animal_name) as display_name " + "from AnimalData a "
					+ "where (a.body_weight + a.brain_weight) > #{parameters.p1,jdbcType=DOUBLE}";
	...
	void testDivide() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					divide(bodyWeight, brainWeight).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testDivideConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					divide(bodyWeight, constant("10.0")).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testMultiply() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					multiply(bodyWeight, brainWeight).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testMultiplyConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					multiply(bodyWeight, constant("2.0")).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testSubtract() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					subtract(bodyWeight, brainWeight).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testSubtractConstant() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					subtract(bodyWeight, constant("5.5")).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testGeneralOperator() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					applyOperator("-", bodyWeight, brainWeight).as("calculated_weight")).from(animalData, "a")
							.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
							.render(RenderingStrategies.MYBATIS3);
	...
	void testComplexExpression() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName,
					add(multiply(bodyWeight, constant("5.5")), subtract(brainWeight, constant("2")))
							.as("calculated_weight")).from(animalData, "a")
									.where(add(bodyWeight, brainWeight), isGreaterThan(10000.0)).build()
									.render(RenderingStrategies.MYBATIS3);
	...
	void testNotLikeCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isNotLike("%squirrel")).build().render(RenderingStrategies.MYBATIS3);
	...
	void testNotLikeCaseInsensistveCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(animalName, isNotLikeCaseInsensitive("%squirrel")).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testDeleteThreeRows() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			DeleteStatementProvider deleteStatement = deleteFrom(animalData).where(id, isIn(5, 8, 10)).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testComplexDelete() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			DeleteStatementProvider deleteStatement = deleteFrom(animalData).where(id, isLessThan(10))
					.or(id, isGreaterThan(60)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testIsNullCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isNull()).build().render(RenderingStrategies.MYBATIS3);
	...
	void testIsNotNullCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isNotNull()).build().render(RenderingStrategies.MYBATIS3);
	...
	void testComplexCondition() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isIn(1, 5, 7)).or(id, isIn(2, 6, 8), and(animalName, isLike("%bat")))
					.or(id, isGreaterThan(60)).and(bodyWeight, isBetween(1.0).and(3.0))
					.orderBy(id.descending(), bodyWeight).build().render(RenderingStrategies.MYBATIS3);
	...
	void testUpdate() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(bodyWeight).equalTo(record.getBodyWeight())
					.set(animalName).equalToNull().where(id, isIn(1, 5, 7))
					.or(id, isIn(2, 6, 8), and(animalName, isLike("%bat"))).or(id, isGreaterThan(60))
					.and(bodyWeight, isBetween(1.0).and(3.0)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testUpdateValueOrNullWithValue() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(animalName).equalToOrNull("fred")
	...
	void testUpdateValueOrNullWithNull() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(animalName).equalToOrNull((String) null)
					.where(id, isEqualTo(1)).build().render(RenderingStrategies.MYBATIS3);

			assertThat(updateStatement.getUpdateStatement())
					.isEqualTo("update AnimalData set animal_name = null where id = #{parameters.p1,jdbcType=INTEGER}");
			int rows = mapper.update(updateStatement);
			assertThat(rows).isEqualTo(1);
		}
	}
	...
	void testInsert() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			InsertStatementProvider<AnimalData> insertStatement = insert(record).into(animalData).map(id)
					.toProperty("id").map(animalName).toProperty("animalName").map(bodyWeight).toProperty("bodyWeight")
					.map(brainWeight).toProperty("brainWeight").build().render(RenderingStrategies.MYBATIS3);
	...
	void testInsertNull() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			InsertStatementProvider<AnimalData> insertStatement = insert(record).into(animalData).map(id)
					.toProperty("id").map(animalName).toNull().map(bodyWeight).toProperty("bodyWeight").map(brainWeight)
					.toProperty("brainWeight").build().render(RenderingStrategies.MYBATIS3);
	...
	void testBulkInsert() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession(ExecutorType.BATCH)) {
			...
			BatchInsert<AnimalData> batchInsert = insertBatch(records).into(animalData).map(id).toProperty("id")
					.map(animalName).toNull().map(bodyWeight).toProperty("bodyWeight").map(brainWeight)
					.toConstant("1.2").build().render(RenderingStrategies.MYBATIS3);

			batchInsert.insertStatements().forEach(mapper::insert);
			sqlSession.commit();

			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isIn(100, 101)).orderBy(id).build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> animals = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(animals).hasSize(2), () -> assertThat(animals.get(0).getId()).isEqualTo(100),
	...
	void testBulkInsert2() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession(ExecutorType.BATCH)) {
			...
			BatchInsert<AnimalData> batchInsert = insertBatch(records).into(animalData).map(id).toProperty("id")
					.map(animalName).toStringConstant("Old Fred").map(bodyWeight).toProperty("bodyWeight")
					.map(brainWeight).toConstant("1.2").build().render(RenderingStrategies.MYBATIS3);
	...
	void testOrderByAndDistinct() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = selectDistinct(id, animalName, bodyWeight, brainWeight)
					.from(animalData).where(id, isLessThan(10)).or(id, isGreaterThan(60))
					.orderBy(id.descending(), animalName).build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> rows = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(rows).hasSize(14), () -> assertThat(rows.get(0).getId()).isEqualTo(65));
		}
	}
	...
	void testOrderByWithFullClause() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isLessThan(10)).or(id, isGreaterThan(60)).orderBy(id.descending()).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testCount() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(count().as("total")).from(animalData, "a").build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select count(*) as total from AnimalData a"),
	...
	void testCountField() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(count(brainWeight).as("total")).from(animalData, "a")
					.build().render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select count(a.brain_weight) as total from AnimalData a"),
					() -> assertThat(count).isEqualTo(65));
		}
	}
	...
	void testCountNoAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(count()).from(animalData).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testMax() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(max(brainWeight).as("total")).from(animalData, "a").build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select max(a.brain_weight) as total from AnimalData a"),
	...
	void testMaxNoAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(max(brainWeight)).from(animalData).build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select max(brain_weight) from AnimalData"),
					() -> assertThat(max).isEqualTo(87000.0));
		}
	}
	...
	void testMaxSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a").where(brainWeight, isEqualTo(select(max(brainWeight)).from(animalData, "b")))
					.build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> records = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(
					"select a.id, a.animal_name, a.body_weight, a.brain_weight from AnimalData a where a.brain_weight = (select max(b.brain_weight) from AnimalData b)"),
	...
	void testMin() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(min(brainWeight).as("total")).from(animalData, "a").build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select min(a.brain_weight) as total from AnimalData a"),
	...
	void testMinNoAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(min(brainWeight)).from(animalData).build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select min(brain_weight) from AnimalData"),
					() -> assertThat(min).isEqualTo(0.005));
		}
	}
	...
	void testMinSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					...
					.orderBy(animalName).build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> records = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(
					"select a.id, a.animal_name, a.body_weight, a.brain_weight from AnimalData a where a.brain_weight <> (select min(b.brain_weight) from AnimalData b) order by animal_name"),
	...
	void testMinSubselectNoAlias() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(brainWeight, isNotEqualTo(select(min(brainWeight)).from(animalData))).orderBy(animalName)
					.build().render(RenderingStrategies.MYBATIS3);

			List<AnimalData> records = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(
					"select id, animal_name, body_weight, brain_weight from AnimalData where brain_weight <> (select min(brain_weight) from AnimalData) order by animal_name"),
					() -> assertThat(records).hasSize(64),
					() -> assertThat(records.get(0).getAnimalName()).isEqualTo("African elephant"));
		}
	}
	...
	void testAvg() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(avg(brainWeight).as("average")).from(animalData, "a")
					.build().render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select avg(a.brain_weight) as average from AnimalData a"),
	...
	void testSum() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(sum(brainWeight).as("total")).from(animalData).build()
					.render(RenderingStrategies.MYBATIS3);
			...
			assertAll(
					() -> assertThat(selectStatement.getSelectStatement())
							.isEqualTo("select sum(brain_weight) as total from AnimalData"),
	...
	void testLessThanSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a")
					.where(brainWeight, isLessThan(select(max(brainWeight)).from(animalData, "b"))).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testLessThanOrEqualToSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a")
					.where(brainWeight, isLessThanOrEqualTo(select(max(brainWeight)).from(animalData, "b"))).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testGreaterThanSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a")
					.where(brainWeight, isGreaterThan(select(min(brainWeight)).from(animalData, "b"))).build()
					.render(RenderingStrategies.MYBATIS3);

			List<AnimalData> records = mapper.selectMany(selectStatement);

			assertAll(() -> assertThat(selectStatement.getSelectStatement()).isEqualTo(
					"select a.id, a.animal_name, a.body_weight, a.brain_weight from AnimalData a where a.brain_weight > (select min(b.brain_weight) from AnimalData b)"),
					() -> assertThat(records).hasSize(64));
		}
	}
	...
	void testGreaterThanOrEqualToSubselect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight)
					.from(animalData, "a")
					.where(brainWeight, isGreaterThanOrEqualTo(select(min(brainWeight)).from(animalData, "b"))).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testInsertSelectWithColumnList() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			InsertSelectStatementProvider insertSelectStatement = insertInto(animalDataCopy)
					...
					.withSelectStatement(
							select(id, animalName, bodyWeight, brainWeight).from(animalData).where(id, isLessThan(22)))
					.build().render(RenderingStrategies.MYBATIS3);
			...
			assertAll(() -> assertThat(insertSelectStatement.getInsertStatement()).isEqualTo(expected),
	...
	void testInsertSelectWithoutColumnList() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			InsertSelectStatementProvider insertSelectStatement = insertInto(animalDataCopy)
					.withSelectStatement(
							select(id, animalName, bodyWeight, brainWeight).from(animalData).where(id, isLessThan(33)))
					.build().render(RenderingStrategies.MYBATIS3);

			String expected = "insert into AnimalDataCopy " + "select id, animal_name, body_weight, brain_weight "
	...
	void testGeneralInsert() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			GeneralInsertStatementProvider insertStatement = insertInto(animalData).set(id).toValue(101).set(animalName)
					.toStringConstant("Fred").set(brainWeight).toConstant("2.2").set(bodyWeight).toValue(4.5).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testGeneralInsertValueOrNullWithValue() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			GeneralInsertStatementProvider insertStatement = insertInto(animalData).set(id).toValue(101).set(animalName)
					.toValueOrNull("Fred").set(brainWeight).toConstant("2.2").set(bodyWeight).toValue(4.5).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testGeneralInsertValueOrNullWithNull() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			GeneralInsertStatementProvider insertStatement = insertInto(animalData).set(id).toValue(101).set(animalName)
					.toValueOrNull((String) null).set(brainWeight).toConstant("2.2").set(bodyWeight).toValue(4.5)
					.build().render(RenderingStrategies.MYBATIS3);

			String expected = "insert into AnimalData (id, animal_name, brain_weight, body_weight) "
					+ "values (#{parameters.p1,jdbcType=INTEGER}, null, 2.2, " + "#{parameters.p2,jdbcType=DOUBLE})";
	...
	void testUpdateWithSelect() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(brainWeight)
					.equalTo(select(avg(brainWeight)).from(animalData).where(brainWeight, isGreaterThan(22.0)))
					.where(brainWeight, isLessThan(1.0)).build().render(RenderingStrategies.MYBATIS3);
			...
			assertAll(() -> assertThat(updateStatement.getUpdateStatement()).isEqualTo(expected),
	...
	void testUpdateWithAddAndSubtract() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(brainWeight)
					.equalTo(add(brainWeight, constant("2"))).set(bodyWeight)
					.equalTo(subtract(bodyWeight, constant("3"))).set(animalName).equalToWhenPresent((String) null)
					.where(id, isEqualTo(1)).build().render(RenderingStrategies.MYBATIS3);
			...
			AnimalData record = MyBatis3Utils.selectOne(mapper::selectOne,
					BasicColumn.columnList(id, bodyWeight, brainWeight), animalData, c -> c.where(id, isEqualTo(1)));
	...
	void testUpdateWithMultiplyAndDivide() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			UpdateStatementProvider updateStatement = update(animalData).set(brainWeight)
					.equalTo(divide(brainWeight, constant("2"))).set(bodyWeight)
					.equalTo(multiply(bodyWeight, constant("3"))).where(id, isEqualTo(1)).build()
					.render(RenderingStrategies.MYBATIS3);
