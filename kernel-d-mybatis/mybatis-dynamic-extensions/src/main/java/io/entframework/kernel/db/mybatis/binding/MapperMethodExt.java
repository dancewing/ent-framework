...
import io.entframework.kernel.db.mybatis.mapping.MappedStatementCreator;
...
public class MapperMethodExt {

	private final SqlCommand command;

	private final MethodSignature method;

	public MapperMethodExt(Class<?> mapperInterface, Method method, Configuration config,
