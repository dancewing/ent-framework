...
@Mapper
public interface GeneralMapperSupport extends CommonCountMapper, CommonDeleteMapper, CommonUpdateMapper,
        CommonSelectMapper, CommonInsertMapper, CommonUpdateRowMapper {
    ...
    default <E> List<E> selectDistinct(Class<E> entityClass, SelectDSLCompleter completer) {
        ...
        return MyBatis3Utils.selectDistinct(this::selectMany, entities.getSelectColumns(), entities.getTable(),
                completer);
    }
    ...
    default <E> int updateByPrimaryKey(E row, boolean selective) {
        ...
        return MyBatis3Utils.updateRow(this::updateRow, row, entities.getTable(), c -> {
            ...
            try {
                ...
                versionColumnOp.ifPresent(
                        versionColumn -> c.where(versionColumn.column()).toProperty(versionColumn.fieldName()));
            }
            catch (Exception ex) {
