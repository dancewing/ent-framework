package io.entframework.kernel.db.mds.listener.impl;
...
public class InitialDefaultValueEntityListener implements EntityListener {
    ...
    public void beforeInsert(Object object) {
        ...
        logicDeleteOptional.ifPresent(fieldAndColumn -> ReflectUtil.setFieldValue(object, fieldAndColumn.fieldName(), YesOrNotEnum.N));
        Optional<FieldAndColumn> versionOptional = entityMeta.findColumn(Version.class);
        versionOptional.ifPresent(fieldAndColumn -> ReflectUtil.setFieldValue(object, fieldAndColumn.fieldName(), VersionFieldUtils.getInitVersionVal(fieldAndColumn.fieldType())));
    }
}
