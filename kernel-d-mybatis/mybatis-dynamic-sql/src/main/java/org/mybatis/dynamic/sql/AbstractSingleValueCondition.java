...
public abstract class AbstractSingleValueCondition<T> implements VisitableCondition<T> {
    ...
    /**
     * If renderable and the value matches the predicate, returns this condition. Else
     * returns a condition that will not render.
     * @param predicate predicate applied to the value, if renderable
     * @return this condition if renderable and the value matches the predicate, otherwise
