...
public class SpringBatchUtility {
    ...
    /**
     * Select builder that renders in a manner appropriate for the
     * MyBatisPagingItemReader.
     *
     * <p>
     * <b>Important</b> rendered SQL will contain LIMIT and OFFSET clauses in the SELECT
     * statement. If your database (Oracle) does not support LIMIT and OFFSET, the queries
     * will fail.
