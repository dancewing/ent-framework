...
/**
 * This rendering strategy should be used for MyBatis3 statements using one of the Spring
 * batch readers supplied by mybatis-spring integration (http://www.mybatis.org/spring/).
