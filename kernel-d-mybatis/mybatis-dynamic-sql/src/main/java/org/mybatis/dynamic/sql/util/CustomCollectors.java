...
public interface CustomCollectors {
	...
	/**
	 * Returns a {@code Collector} similar to the standard JDK joining collector, except
	 * that this collector returns an empty string if there are no elements to collect.
	 ...
	 * @return A {@code Collector} which concatenates CharSequence elements, separated by
