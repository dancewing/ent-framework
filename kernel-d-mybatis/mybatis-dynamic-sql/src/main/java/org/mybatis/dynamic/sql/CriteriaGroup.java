...
/**
 * This class represents a criteria group without an AND or an OR connector. This is
 * useful in situations where the initial SqlCriterion in a list should be further grouped
