...
public interface SortSpecification {
	...
	/**
	 * Returns a new instance of the SortSpecification that should render as descending in
	 * an ORDER BY clause.
	...
	/**
	 * Return the phrase that should be written into a rendered order by clause. This
	 * should NOT include the "DESC" word for descending sort specifications.
