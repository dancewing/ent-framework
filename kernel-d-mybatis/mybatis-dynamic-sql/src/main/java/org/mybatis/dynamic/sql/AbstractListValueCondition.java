...
public abstract class AbstractListValueCondition<T> implements VisitableCondition<T> {
	...
	/**
	 * If renderable, apply the predicate to each value in the list and return a new
	 * condition with the filtered values. Else returns a condition that will not render
	 * (this). If all values are filtered out of the value list, then the condition will
	 * not render.
	...
	/**
	 * Specifies a callback function to be called if the value list is empty when
	 * rendered.
