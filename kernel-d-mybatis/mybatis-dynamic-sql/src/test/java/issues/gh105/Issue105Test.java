...
class Issue105Test {
    ...
    void testFuzzyLikeBothPresent() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isLike(fName).filter(Objects::nonNull).map(s -> "%" + s + "%"))
                .and(lastName, isLike(lName).filter(Objects::nonNull).map(s -> "%" + s + "%")).build()
                .render(RenderingStrategies.MYBATIS3);

        String expected = "select person_id, first_name, last_name" + " from Person"
                + " where first_name like #{parameters.p1}" + " and last_name like #{parameters.p2}";
    ...
    void testFuzzyLikeFirstNameNull() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                ...
                .and(lastName, isLike(lName).filter(Objects::nonNull).map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testBetweenTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isBetween(1).and(10).map(i1 -> i1 + 1, i2 -> i2 + 2)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testBetweenWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isBetweenWhenPresent(1).and(10).map(i1 -> i1 + 1, i2 -> i2 + 2)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testEqualTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isEqualTo(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);

        String expected = "select person_id, first_name, last_name" + " from Person" + " where age = #{parameters.p1}";
    ...
    void testEqualWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isEqualToWhenPresent(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testGreaterThanTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isGreaterThan(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testGreaterThanOrEqualTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isGreaterThanOrEqualTo(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testGreaterThanOrEqualWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isGreaterThanOrEqualToWhenPresent(1).map(i -> i + 1)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testGreaterThanWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isGreaterThanWhenPresent(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testLessThanTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isLessThan(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testLessThanOrEqualTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isLessThanOrEqualTo(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testLessThanOrEqualWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isLessThanOrEqualToWhenPresent(1).map(i -> i + 1)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testLessThanWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isLessThanWhenPresent(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testLikeTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isLike("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testLikeCaseInsensitiveTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isLikeCaseInsensitive("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testLikeCaseInsensitiveWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isLikeCaseInsensitiveWhenPresent("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testLikeWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isLikeWhenPresent("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotBetweenTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isNotBetween(1).and(10).map(i1 -> i1 + 1, i2 -> i2 + 2)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotBetweenWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isNotBetweenWhenPresent(1).and(10).map(i1 -> i1 + 1, i2 -> i2 + 2)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotEqualTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isNotEqualTo(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testNotEqualWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age, isNotEqualToWhenPresent(1).map(i -> i + 1)).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testNotLikeTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isNotLike("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotLikeCaseInsensitiveTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isNotLikeCaseInsensitive("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotLikeCaseInsensitiveWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isNotLikeCaseInsensitiveWhenPresent("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotLikeWhenPresentTransform() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName, isNotLikeWhenPresent("fred").map(SearchUtils::addWildcards)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testBetweenTransformWithNull() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age,
                        isBetween(1).and((Integer) null).filter(Predicates.bothPresent()).map(i1 -> i1 + 1,
                                i2 -> i2 + 2))
                .configureStatement(c -> c.setNonRenderingWhereClauseAllowed(true)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testLikeCaseInsensitiveTransformWithNull() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName,
                        isLikeCaseInsensitive((String) null).filter(Objects::nonNull).map(SearchUtils::addWildcards))
                .configureStatement(c -> c.setNonRenderingWhereClauseAllowed(true)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotBetweenTransformWithNull() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(age,
                        isNotBetween((Integer) null).and(10).filter(Predicates.bothPresent()).map(i1 -> i1 + 1,
                                i2 -> i2 + 2))
                .configureStatement(c -> c.setNonRenderingWhereClauseAllowed(true)).build()
                .render(RenderingStrategies.MYBATIS3);
    ...
    void testNotLikeCaseInsensitiveTransformWithNull() {
        ...
        SelectStatementProvider selectStatement = select(id, firstName, lastName).from(person)
                .where(firstName,
                        isNotLikeCaseInsensitive((String) null).filter(Objects::nonNull).map(SearchUtils::addWildcards))
                .configureStatement(c -> c.setNonRenderingWhereClauseAllowed(true)).build()
                .render(RenderingStrategies.MYBATIS3);
