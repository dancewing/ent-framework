...
class SelectStatementTest {
    ...
    void testSimpleCriteriaWithoutAlias() {
        ...
        SelectStatementProvider selectStatement = select(column1, column2).from(table, "a").where(column1, isEqualTo(d))
                .or(column2, isEqualTo(4)).and(column2, isLessThan(3)).build().render(RenderingStrategies.MYBATIS3);
        ...
        assertAll(() -> assertThat(parameters).containsEntry("p1", d),
    ...
    void testComplexCriteriaWithoutAlias() {
        ...
        SelectStatementProvider selectStatement = select(column1, column2).from(table, "a").where(column1, isEqualTo(d))
                .or(column2, isEqualTo(4)).and(column2, isLessThan(3))
        ...
        String expected = "select a.column1, a.column2 " + "from foo a "
    ...
    void testComplexCriteriaWithAlias() {
        ...
        SelectStatementProvider selectStatement = select(column1, column2).from(table, "a").where(column1, isEqualTo(d))
                ...
                .and(column2, isLessThan(3), or(column1, isEqualTo(d), and(column2, isEqualTo(88)))).build()
