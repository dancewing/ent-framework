...
class InvalidSQLTest {
    ...
    void testInvalidGeneralInsertStatement() {
        GeneralInsertModel.Builder builder = new GeneralInsertModel.Builder().withTable(person);
    ...
    void testInvalidGeneralInsertStatementWhenAllOptionalsAreDropped() {
        GeneralInsertModel model = insertInto(person).set(id).toValueWhenPresent((Integer) null).build();
    ...
    void testInvalidInsertStatement() {
        InsertModel.Builder<TestRow> builder = new InsertModel.Builder<TestRow>().withTable(person)
                .withRow(new TestRow());
    ...
    void testInvalidInsertStatementWhenAllOptionalsAreDropped() {
        ...
        InsertModel<TestRow> model = insert(testRow).into(person).map(id).toPropertyWhenPresent("id", testRow::getId)
                .build();
    ...
    void testInvalidMultipleInsertStatementNoRecords() {
        MultiRowInsertModel.Builder<TestRow> builder = new MultiRowInsertModel.Builder<TestRow>().withTable(person);
    ...
    void testInvalidMultipleInsertStatementNoMappings() {
        ...
        MultiRowInsertModel.Builder<TestRow> builder = new MultiRowInsertModel.Builder<TestRow>().withRecords(records)
                .withTable(person);
    ...
    void testInvalidBatchInsertStatementNoRecords() {
        BatchInsertModel.Builder<TestRow> builder = new BatchInsertModel.Builder<TestRow>().withTable(person);
    ...
    void testInvalidBatchInsertStatementNoMappings() {
        ...
        BatchInsertModel.Builder<TestRow> builder = new BatchInsertModel.Builder<TestRow>().withRecords(records)
                .withTable(person);
    ...
    void testInvalidSelectStatementWithoutColumnList() {
        QueryExpressionModel.Builder builder = new QueryExpressionModel.Builder().withTable(person);
    ...
    void testInvalidSelectStatementJoinSpecification() {
        JoinSpecification.Builder builder = new JoinSpecification.Builder().withJoinTable(person)
    ...
    void testInvalidUpdateStatement() {
        UpdateModel.Builder builder = new UpdateModel.Builder().withTable(person);
    ...
    void testInvalidUpdateStatementWhenAllOptionalsAreDropped() {
        UpdateModel model = update(person).set(id).equalToWhenPresent((Integer) null).build();
