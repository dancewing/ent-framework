...
class UpdateStatementTest {
    ...
    void testUpdateParameterWithMultipleCriteria() {
        UpdateStatementProvider updateStatement = update(foo).set(firstName).equalTo("fred").set(lastName)
                .equalTo("jones").set(occupation).equalToNull()
                .where(id, isEqualTo(3), or(id, isEqualTo(4)), or(id, isEqualTo(5))).build()
    ...
    void testUpdateParameterStartWithNull() {
        UpdateStatementProvider updateStatement = update(foo).set(occupation).equalToNull().set(firstName)
                .equalTo("fred").set(lastName).equalTo("jones").where(id, isEqualTo(3))
                .and(firstName, isEqualTo("barney")).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testUpdateParameterStartWithConstant() {
        UpdateStatementProvider updateStatement = update(foo).set(occupation).equalToStringConstant("Y").set(firstName)
                .equalTo("fred").set(lastName).equalTo("jones").set(id).equalToConstant("4").where(id, isEqualTo(3))
                .and(firstName, isEqualTo("barney")).build().render(RenderingStrategies.MYBATIS3);
    ...
    void testFullUpdateStatement() {
        UpdateStatementProvider updateStatement = update(foo).set(firstName).equalTo("fred").set(lastName)
                .equalTo("jones").set(occupation).equalToNull().where(id, isEqualTo(3)).build()
                .render(RenderingStrategies.MYBATIS3);
        ...
        assertAll(() -> assertThat(updateStatement.getUpdateStatement()).isEqualTo(expectedStatement),
    ...
    void testFullUpdateStatementNoWhere() {
        UpdateStatementProvider updateStatement = update(foo).set(firstName).equalTo("fred").set(lastName)
                .equalTo("jones").set(occupation).equalToNull().build().render(RenderingStrategies.MYBATIS3);
    ...
    void testUpdateStatementArithmeticOperation() {
        UpdateStatementProvider updateStatement = update(foo).set(id).equalTo(add(id, constant("1"))).set(id)
                .equalTo(subtract(id, constant("2"))).set(id).equalTo(multiply(id, constant("3"))).set(id)
                .equalTo(divide(id, constant("4"))).build().render(RenderingStrategies.MYBATIS3);

        String expectedStatement = "update foo " + "set id = (id + 1), " + "id = (id - 2), " + "id = (id * 3), "
                + "id = (id / 4)";
    ...
    void testUpdateSelectStatement() {
        UpdateStatementProvider updateStatement = update(foo).set(lastName).equalTo("Jones").set(firstName)
                .equalTo(select(firstName).from(foo).where(id, isEqualTo(4))).where(id, isEqualTo(3)).build()
                .render(RenderingStrategies.MYBATIS3);
