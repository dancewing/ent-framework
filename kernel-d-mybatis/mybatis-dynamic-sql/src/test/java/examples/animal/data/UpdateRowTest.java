    ...
    void testUpdateRow() throws Exception {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            UpdateRowStatementProvider<AnimalData> updateRowStatementProvider = SqlBuilder.updateRow(animal)
                    .into(animalData)
                    .set(animalName).toProperty("animalName")
                    .set(bodyWeight).toProperty("bodyWeight")
                    .set(brainWeight).toValue(5d)
                    .where(id).toProperty("id")
            ...
            assertAll(
                    ...
                    () -> assertThat(animal2.getId()).isEqualTo(1),
                    () -> assertNull(animal2.getAnimalName()),
                    () -> assertThat(animal2.getBodyWeight()).isEqualTo(2d),
