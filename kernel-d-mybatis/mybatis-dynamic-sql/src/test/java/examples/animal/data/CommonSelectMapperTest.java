...
class CommonSelectMapperTest {
	...
	void testGeneralSelectOne() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			SelectStatementProvider selectStatement = select(id.asCamelCase(), animalName.asCamelCase())
					.from(animalData).where(id, isEqualTo(1)).build().render(RenderingStrategies.MYBATIS3);
	...
	void testGeneralSelectMany() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(id, animalName).from(animalData).where(id, isIn(1, 2))
	...
	void testGeneralSelectManyWithRowMapper() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(id, animalName, bodyWeight, brainWeight).from(animalData)
					.where(id, isIn(1, 2)).orderBy(id).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectOneBigDecimal() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(bodyWeight).from(animalData).where(id, isEqualTo(1))
	...
	void testSelectOptionalBigDecimalPresent() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			...
			assertThat(bodyWeight).hasValueSatisfying(
					bw -> assertThat(bw).isCloseTo(new BigDecimal("0.14"), Percentage.withPercentage(0.01)));
		}
	}
	...
	void testSelectOptionalBigDecimalMissing() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(bodyWeight).from(animalData).where(id, isEqualTo(1000))
					.build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectManyBigDecimals() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(bodyWeight).from(animalData).where(id, isIn(1, 2))
					.orderBy(id).build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectOneInteger() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(id).from(animalData).where(id, isEqualTo(1)).build()
	...
	void testSelectOptionalIntegerMissing() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(id).from(animalData).where(id, isEqualTo(1000)).build()
					.render(RenderingStrategies.MYBATIS3);
	...
	void testSelectManyIntegers() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(id).from(animalData).where(id, isIn(1, 2)).orderBy(id)
					.build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectOneString() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(animalName).from(animalData).where(id, isEqualTo(1))
					.build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectOptionalStringMissing() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(animalName).from(animalData).where(id, isEqualTo(1000))
					.build().render(RenderingStrategies.MYBATIS3);
	...
	void testSelectManyStrings() {
		try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
			CommonSelectMapper mapper = sqlSession.getMapper(CommonSelectMapper.class);
			SelectStatementProvider selectStatement = select(animalName).from(animalData).where(id, isIn(1, 2))
					.orderBy(id).build().render(RenderingStrategies.MYBATIS3);
