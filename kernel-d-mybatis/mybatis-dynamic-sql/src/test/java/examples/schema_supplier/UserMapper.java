...
public interface UserMapper {
    ...
    @Results(id = "UserResult",
            value = { @Result(column = "USER_ID", property = "id", jdbcType = JdbcType.INTEGER, id = true),
    ...
    default int insert(User record) {
        return insert(SqlBuilder.insert(record).into(user).map(id).toProperty("id").map(name).toProperty("name").build()
