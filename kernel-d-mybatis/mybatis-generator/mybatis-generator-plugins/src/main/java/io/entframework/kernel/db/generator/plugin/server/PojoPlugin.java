...
public class PojoPlugin extends AbstractServerPlugin {
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (StringUtils.isAnyEmpty(this.pojoRequestTargetPackage, this.pojoRequestSuffix,
                this.pojoResponseTargetPackage, this.pojoResponseSuffix,
                this.mapstructTargetPackage, this.mapstructSuffix)) {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
        ...
        PojoFieldsGenerator pojoFieldsGenerator = new PojoFieldsGenerator(this.context, this.codingStyle,
                this.pojoRequestTargetPackage, this.pojoRequestSuffix,
                this.pojoResponseTargetPackage, this.pojoResponseSuffix, qualifiedJavaType);
    ...
    private GeneratedJavaFile generatePojoRequest(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, PojoFieldsGenerator pojoFieldsGenerator) {
        ...
        return new GeneratedJavaFile(pojoRequestClass,
                context.getJavaModelGeneratorConfiguration().getTargetProject(),
                context.getProperty(PropertyRegistry.CONTEXT_JAVA_FILE_ENCODING),
                context.getJavaFormatter());
    }

    private GeneratedJavaFile generatePojoResponse(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, PojoFieldsGenerator pojoFieldsGenerator) {
        String modelObjectName = topLevelClass.getType().getShortNameWithoutTypeArguments();
        ...
        return new GeneratedJavaFile(pojoResponseClass,
                context.getJavaModelGeneratorConfiguration().getTargetProject(),
                context.getProperty(PropertyRegistry.CONTEXT_JAVA_FILE_ENCODING),
                context.getJavaFormatter());
