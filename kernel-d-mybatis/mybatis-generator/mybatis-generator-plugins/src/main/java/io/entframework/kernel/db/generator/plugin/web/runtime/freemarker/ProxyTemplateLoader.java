...
/**
 * A {@link TemplateLoader} that uses a set of other loaders to load the templates. On
 ...
 * {@link #setSticky(boolean)}, then the loaders are always queried in the order of their
 * appearance in the array.
 *
 * <p>
 * This class is thread-safe.
 */
public class ProxyTemplateLoader implements StatefulTemplateLoader {
     ...
     * @param templateLoaders the template loaders that are used to load templates, in the
     * order as they will be searched (except where {@linkplain #setSticky(boolean)
     * stickiness} says otherwise).
     */
    public ProxyTemplateLoader(TemplateLoader[] templateLoaders) {
    ...
    /**
     * Represents a template source bound to a specific template loader. It serves as the
     * complete template source descriptor used by the MultiTemplateLoader class.
     */
     ...
     * @param index Must be below {@link #getTemplateLoaderCount()}.
     */
    ...
    /**
     * Sets if for a name that was already loaded earlier the same {@link TemplateLoader}
     * will be tried first, or we always try the {@link TemplateLoader}-s strictly in the
     * order as it was specified in the constructor. The default is {@code true}.
     *
     * @since 2.3.24
     */
