...
public class ServicePlugin extends AbstractServerPlugin {
	...
	private GeneratedJavaFile generateBaseServiceInterface(Interface clientInterface,
		...
		return new GeneratedJavaFile(serviceInterface, context.getJavaModelGeneratorConfiguration().getTargetProject(),
	...
	private GeneratedJavaFile generateBaseServiceInterfaceImpl(Interface clientInterface,
		...
		FullyQualifiedJavaType requestClsJavaType = new FullyQualifiedJavaType(
				String.format("Class<? extends %s>", pojoRequestJavaType.getShortName()));
		FullyQualifiedJavaType responseClsJavaType = new FullyQualifiedJavaType(
				String.format("Class<? extends %s>", pojoResponseJavaType.getShortName()));
