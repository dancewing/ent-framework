...
public class JavaBeansUtil {
	...
	/**
	 * Computes a getter method name. Warning - does not check to see that the property is
	 * a valid property. Call getValidPropertyName first.
	...
	/**
	 * Computes a setter method name. Warning - does not check to see that the property is
	 * a valid property. Call getValidPropertyName first.
	 * @param property the property
	 ...
	 * <li>If the first character is upper case, and the second character is lower case,
	 * then the first character should be made lower case</li>
	 * </ol>
	 *
	 * <p>
	 * For example:
