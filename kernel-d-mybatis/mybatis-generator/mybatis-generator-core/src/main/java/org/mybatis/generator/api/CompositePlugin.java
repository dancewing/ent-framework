...
/**
 * This class implements a composite plugin. It contains a list of plugins for the current
 * context and is used to aggregate plugins together. This class implements the rule that
 * if any plugin returns "false" from a method, then no subsequent plugin is called.
 *
 * @author Jeff Butler
 *
 */
