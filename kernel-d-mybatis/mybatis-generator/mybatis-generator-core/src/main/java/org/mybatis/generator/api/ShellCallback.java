...
public interface ShellCallback {
    ...
    /**
     * This method is called to ask the shell to resolve a project/package combination
     * into a directory on the file system. This method is called repeatedly (once for
     * each generated file), so it would be wise for an implementing class to cache
     * results.
     *
     * <p>
     ...
     * @throws ShellException if the project/package cannot be resolved into a directory
     * on the file system. In this case, the generator will not save the file it is
     * currently working on. The generator will add the exception message to the list of
