...
/**
 * This plugin adds equals() and hashCode() methods to the generated model classes. It
 * demonstrates the process of adding methods to generated classes
 *
 * <p>
 * The <code>equals</code> method generated by this class is correct in most cases, but
 * will probably NOT be correct if you have specified a rootClass - because our equals
 * method only checks the fields it knows about.
 *
 * <p>
 * Similarly, the <code>hashCode</code> method generated by this class only relies on
 * fields it knows about. Anything you add, or fields in a super class will not be
 * factored into the hash code.
 *
 * @author Jeff Butler
 *
 */
public class EqualsHashCodePlugin extends PluginAdapter {
	 ...
	 * @param introspectedColumns column definitions of this class and any superclass of
	 * this class
