...
/**
 * This plugin adds a CacheNamespace annotation to generated Java or Kotlin mapper
 * interfaces. The plugin accepts the following properties (all are optional):
 *
 * <ul>
 ...
 * CacheNamespace annotation. Most properties are passed "as is" to the corresponding
 * properties of the generated annotation. The properties "cache_implementation" and
 * "cache_eviction" must be fully qualified class names. If specified, the values will be
 * added to the import list of the mapper file, and the short names will be used in the
 * generated annotation. All properties can be specified at the table level, or on the
 * plugin element. The property on the table element will override any property on the
 * plugin element.
 *
 * <p>
 * If the "cache_skip" property is set to "true" - either on the plugin or on a specific
 * table, the annotation will not be applied to the generated interface.
 *
 * @author Jeff Butler
 */
