...
public enum DevOpsExceptionEnum implements AbstractExceptionEnum {
     ...
     */
    HTTP_ERROR(RuleConstants.BUSINESS_ERROR_TYPE_CODE + ScannerConstants.RESOURCE_MODULE_NAME + "01",
            "DevOps汇报资源出错，Http调用出错！"),

    /**
     * DevOps汇报资源出错，Http调用获取返回结果出错！
     */
    HTTP_RESPONSE_EMPTY(RuleConstants.BUSINESS_ERROR_TYPE_CODE + ScannerConstants.RESOURCE_MODULE_NAME + "02",
            "DevOps汇报资源出错，Http调用获取返回结果为空！"),

    /**
     * DevOps汇报资源出错，Http调用获取返回结果出错！
     */
    HTTP_RESPONSE_ERROR(RuleConstants.BUSINESS_ERROR_TYPE_CODE + ScannerConstants.RESOURCE_MODULE_NAME + "02",
            "DevOps汇报资源出错，Http调用获取返回结果错误！具体原因为：{}");
