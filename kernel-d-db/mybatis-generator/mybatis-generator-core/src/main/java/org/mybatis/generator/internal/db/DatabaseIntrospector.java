...
public class DatabaseIntrospector {
     ...
     */
    public List<IntrospectedTable> introspectTables(TableConfiguration tc, String catalog)
            throws SQLException {
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
            ...
            for (IntrospectedColumn introspectedColumn : entry.getValue()) {
                ...
                FullyQualifiedJavaType fullyQualifiedJavaType = javaTypeResolver
                        .calculateJavaType(entry.getKey() ,introspectedColumn);
            ...
            for (IntrospectedColumn introspectedColumn : entry.getValue()) {
                ...
                if (columnOverride != null) {
                    ...
                    if (stringHasValue(columnOverride
                        ...
                        introspectedColumn
                                .setFullyQualifiedJavaType(fqjt);
                    }
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
            TableConfiguration tc, String catalog) throws SQLException {
        String localCatalog;
        String localSchema;
        ...
        while (rs.next()) {
            ...
            if (stringHasValue(atn.getCatalog()) && stringHasValue(catalog) && StringUtils.equals(atn.getCatalog(), catalog)) {
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
            ...
            if (ContextHelper.containsSqlWildcard(tc.getTableName())) {
                ...
                boolean hasExtractTableConfig = context.hasExtractTableConfig(introspectedTable.getFullyQualifiedTable().getIntrospectedTableName());
