...
public final class TeacherDynamicSqlSupport {
	...
	public static final BasicColumn[] selectList = BasicColumn.columnList(id, name, cardNum, gender, birthday,
			workSeniority, statusFlag, techCourses, version, createTime, createUser, updateTime, updateUser,
			createUserName, updateUserName, properties);
	...
	public static final class Teacher extends AliasableSqlTable<Teacher> {
		...
		public final SqlColumn<List<String>> techCourses = column("tech_courses", JDBCType.VARCHAR,
