...
public final class HistoryScoreDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(id, studentId, examTime, examType, totalScore,
            createTime, createUser, updateTime, updateUser, createUserName, updateUserName, score);
    ...
    public static final class HistoryScore extends AliasableSqlTable<HistoryScore> {
        ...
        public final SqlColumn<Map<String, Integer>> score = column("score", JDBCType.LONGVARCHAR,
                "io.entframework.kernel.db.dao.mybatis.handler.ScoreMapHandler");
