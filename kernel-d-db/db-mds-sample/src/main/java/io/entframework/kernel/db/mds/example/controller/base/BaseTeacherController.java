...
public abstract class BaseTeacherController {
    ...
    public ResponseData<TeacherResponse> update(@RequestBody @Validated(BaseRequest.update.class) TeacherRequest request) {
    ...
    public ResponseData<Integer> batchDelete(@RequestBody @Validated(BaseRequest.batchDelete.class) TeacherRequest request) {
