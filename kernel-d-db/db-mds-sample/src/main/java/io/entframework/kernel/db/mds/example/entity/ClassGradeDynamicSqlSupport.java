...
public final class ClassGradeDynamicSqlSupport {
	...
	public static final BasicColumn[] selectList = BasicColumn.columnList(id, name, description, gradeType, startTime,
			regulatorId, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
