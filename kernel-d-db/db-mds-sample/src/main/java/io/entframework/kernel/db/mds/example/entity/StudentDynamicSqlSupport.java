...
public final class StudentDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(id, gradeId, name, cardNum, gender, birthday,
            takeCourses, fromForeign, hometown, delFlag, version, createTime, createUser, updateTime, updateUser,
            createUserName, updateUserName, hobbies);
    ...
    public static final class Student extends AliasableSqlTable<Student> {
        ...
        public final SqlColumn<List<String>> takeCourses = column("take_courses", JDBCType.VARCHAR,
                "io.entframework.kernel.db.dao.mybatis.handler.StringListHandler");
