...
public final class AutoIncrementDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(id, username, createTime, createUser,
            updateTime, updateUser, createUserName, updateUserName);
