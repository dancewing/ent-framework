...
public abstract class BaseStudentController {
    ...
    public ResponseData<StudentResponse> update(
            @RequestBody @Validated(BaseRequest.update.class) StudentRequest request) {
    ...
    public ResponseData<Integer> batchDelete(
            @RequestBody @Validated(BaseRequest.batchDelete.class) StudentRequest request) {
