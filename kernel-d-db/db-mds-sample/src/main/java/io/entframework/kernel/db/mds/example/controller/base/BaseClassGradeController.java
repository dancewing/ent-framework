...
public abstract class BaseClassGradeController {
    ...
    public ResponseData<ClassGradeResponse> insert(
            @RequestBody @Validated(BaseRequest.add.class) ClassGradeRequest request) {
    ...
    public ResponseData<ClassGradeResponse> update(
            @RequestBody @Validated(BaseRequest.update.class) ClassGradeRequest request) {
    ...
    public ResponseData<Integer> batchDelete(
            @RequestBody @Validated(BaseRequest.batchDelete.class) ClassGradeRequest request) {
