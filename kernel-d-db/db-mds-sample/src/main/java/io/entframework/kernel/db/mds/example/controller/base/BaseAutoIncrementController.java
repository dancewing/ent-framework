...
public abstract class BaseAutoIncrementController {
    ...
    public ResponseData<AutoIncrementResponse> insert(@RequestBody @Validated(BaseRequest.add.class) AutoIncrementRequest request) {
    ...
    public ResponseData<AutoIncrementResponse> update(@RequestBody @Validated(BaseRequest.update.class) AutoIncrementRequest request) {
    ...
    public ResponseData<Integer> delete(@RequestBody @Validated(BaseRequest.delete.class) AutoIncrementRequest request) {
    ...
    public ResponseData<Integer> batchDelete(@RequestBody @Validated(BaseRequest.batchDelete.class) AutoIncrementRequest request) {
