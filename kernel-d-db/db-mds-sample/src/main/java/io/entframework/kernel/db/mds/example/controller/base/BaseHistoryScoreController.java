...
public abstract class BaseHistoryScoreController {
	...
	public ResponseData<HistoryScoreResponse> insert(
			@RequestBody @Validated(BaseRequest.add.class) HistoryScoreRequest request) {
	...
	public ResponseData<HistoryScoreResponse> update(
			@RequestBody @Validated(BaseRequest.update.class) HistoryScoreRequest request) {
	...
	public ResponseData<Integer> batchDelete(
			@RequestBody @Validated(BaseRequest.batchDelete.class) HistoryScoreRequest request) {
