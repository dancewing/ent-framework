...
public interface GeneralRepository {
     ...
     * <br/>
     */
    default <E> SelectDSLCompleter defaultSelectDSL(E row, Integer pageNo, Integer pageSize, SortSpecification orderBy) {
        return c -> {
    ...
    default <E> QueryExpressionDSL<SelectModel> defaultQuerySelectDSL(E row, Integer pageNo, Integer pageSize, SortSpecification orderBy) {
