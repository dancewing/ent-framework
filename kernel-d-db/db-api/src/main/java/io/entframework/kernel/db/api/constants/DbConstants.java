...
public interface DbConstants {
     ...
     * druid控制台的监控数据默认不能清空
     */
    boolean DEFAULT_DRUID_ADMIN_RESET_ENABLE = false;
     ...
     */
    boolean DRUID_WEB_STAT_FILTER_SESSION_STAT_ENABLE = false;
     ...
     */
    int DRUID_WEB_STAT_FILTER_SESSION_STAT_MAX_COUNT = 1000;
     ...
     */
    boolean DRUID_WEB_STAT_FILTER_PROFILE_ENABLE = true;
