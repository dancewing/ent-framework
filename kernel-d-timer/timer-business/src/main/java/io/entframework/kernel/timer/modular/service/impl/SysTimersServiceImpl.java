 ...
 */
@Service
public class SysTimersServiceImpl extends BaseServiceImpl<SysTimersRequest, SysTimersResponse, SysTimers>
	...
	public SysTimersResponse update(SysTimersRequest sysTimersRequest) {
		...
		if (TimerJobStatusEnum.RUNNING == jobStatus) {
			...
			timerExeService.startTimer(String.valueOf(sysTimersRequest.getTimerId()), sysTimersRequest.getCron(),
					sysTimersRequest.getActionClass(), sysTimersRequest.getParams());
		}
