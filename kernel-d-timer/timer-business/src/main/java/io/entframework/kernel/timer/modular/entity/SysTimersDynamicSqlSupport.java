...
public final class SysTimersDynamicSqlSupport {
	...
	public static final BasicColumn[] selectList = BasicColumn.columnList(timerId, timerName, actionClass, cron, params,
			jobStatus, remark, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
