...
public class SysTimersController {
    ...
    public ResponseData<Void> update(@RequestBody @Validated(BaseRequest.update.class) SysTimersRequest sysTimersRequest) {
    ...
    public ResponseData<Void> start(@RequestBody @Validated(SysTimersRequest.startTimer.class) SysTimersRequest sysTimersRequest) {
    ...
    public ResponseData<Void> stop(@RequestBody @Validated(SysTimersRequest.stopTimer.class) SysTimersRequest sysTimersRequest) {
