...
public final class SysLogDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(logId, logName, logContent, appName,
            requestUrl, serverIp, clientIp, userId, httpMethod, clientBrowser, clientOs, createTime, createUserName,
            requestParams, requestResult);
