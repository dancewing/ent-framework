...
public class CollectionUtils {
	 ...
	 * <a href="https://bugs.openjdk.java.net/browse/JDK-8161372">Link</a>
	...
	/**
	 * Returns a capacity that is sufficient to keep the map from being resized as long as
	 * it grows no larger than expectedSize and the load factor is >= its default (0.75).
	 */
