...
public class ResponseRenderUtil {
     ...
     * @date 2020/12/15 21:40
     */
    public static void renderErrorResponse(HttpServletResponse response, String code, String message,
    ...
    public static void setRenderFileHeader(HttpServletResponse response, String fileName) {
        ...
        response.setHeader("Content-Disposition", CharSequenceUtil.format("attachment;filename={}",
                URLEncodeUtil.encode(fileName, Charset.forName(charset))));
