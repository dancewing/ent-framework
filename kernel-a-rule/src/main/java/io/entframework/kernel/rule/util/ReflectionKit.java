...
import io.entframework.kernel.rule.exception.enums.defaults.DefaultSystemExceptionEnum;
...
public final class ReflectionKit {
    ...
    public static Object getFieldValue(Object entity, String fieldName) {
        ...
        try {
            ...
            Assert.notNull(field, "Error: NoSuchField in {} for {}.  Cause:", cls.getSimpleName(), fieldName);
            field.setAccessible(true);
            return field.get(entity);
        }
        catch (ReflectiveOperationException e) {
            throw new ServiceException(RuleConstants.RULE_MODULE_NAME, DefaultSystemExceptionEnum.CAN_NOT_READ_FIELD);
        }
    }
    ...
    public static Map<String, Field> getFieldMap(Class<?> clazz) {
        ...
        return CollectionUtils.isNotEmpty(fieldList)
                ? fieldList.stream().collect(Collectors.toMap(Field::getName, field -> field)) : Collections.emptyMap();
    }
