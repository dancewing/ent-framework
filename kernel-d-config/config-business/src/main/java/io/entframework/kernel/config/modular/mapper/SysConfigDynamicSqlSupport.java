...
public final class SysConfigDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(configId, configName, configCode, configValue, sysFlag, remark, statusFlag, groupCode, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
