...
public class JwtTokenOperator implements JwtApi {
    ...
    public String generateToken(Map<String, Object> payload) {
        ...
        // 构造jwt token
        return Jwts.builder().setClaims(payload).setIssuedAt(new Date()).setExpiration(expirationDate)
    ...
    public String generateTokenDefaultPayload(DefaultJwtPayload defaultJwtPayload) {
        ...
        // 构造jwt token
        return Jwts.builder().setClaims(BeanUtil.beanToMap(defaultJwtPayload))
