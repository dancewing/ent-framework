 ...
 ******************************************************************************/
package io.entframework.kernel.security.count;
...
import io.entframework.kernel.security.api.exception.CountValidateException;
import io.entframework.kernel.security.api.exception.enums.CountValidateExceptionEnum;
...
public class DefaultCountValidator implements CountValidatorApi {
	...
	@Override
	public synchronized void countAndValidate(String key, Long timeWindowSeconds, Long timeWindowMaxCount)
		...
		String recordTimeSecondsKey = CounterConstants.COUNT_VALIDATE_CACHE_KEY_PREFIX + CacheConstants.CACHE_DELIMITER
				+ key + CacheConstants.CACHE_DELIMITER + CounterConstants.RECORD_TIME_SECONDS;

		// 上一次执行次数的记录缓存key COUNT_VALIDATE:key:COUNT_NUMBER
		String countNumberKey = CounterConstants.COUNT_VALIDATE_CACHE_KEY_PREFIX + CacheConstants.CACHE_DELIMITER + key
				+ CacheConstants.CACHE_DELIMITER + CounterConstants.COUNT_NUMBER;
