...
public class KernelXssAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "kernel.security.xss", name = "enabled", havingValue = "true", matchIfMissing = true)
    ...
    public Jackson2ObjectMapperBuilderCustomizer xssJackson2ObjectMapperBuilderCustomizer(XssProperties properties) {
        return jacksonObjectMapperBuilder ->
                jacksonObjectMapperBuilder.deserializerByType(String.class, new XssJacksonDeserializer(properties));
    }
