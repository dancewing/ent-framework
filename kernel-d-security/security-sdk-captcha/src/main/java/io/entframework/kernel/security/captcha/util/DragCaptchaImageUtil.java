...
package io.entframework.kernel.security.captcha.util;
...
public class DragCaptchaImageUtil {
    ...
    public static DragCaptchaImageDTO getVerifyImage(InputStream inputStream) throws IOException {
        ...
        int locationX = CUT_WIDTH + RANDOM.nextInt(srcImage.getWidth() - CUT_WIDTH * 3);
        int locationY = CUT_HEIGHT + RANDOM.nextInt(srcImage.getHeight() - CUT_HEIGHT) / 2;
