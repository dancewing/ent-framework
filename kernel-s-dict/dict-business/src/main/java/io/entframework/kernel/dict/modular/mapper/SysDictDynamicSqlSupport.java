...
public final class SysDictDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(dictId, dictCode, dictName, dictNamePinyin, dictEncode, dictTypeCode, dictShortName, dictShortCode, dictParentId, statusFlag, dictSort, dictPids, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
