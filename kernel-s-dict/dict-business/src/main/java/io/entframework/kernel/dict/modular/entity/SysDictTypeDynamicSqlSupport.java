...
public final class SysDictTypeDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(dictTypeId, dictTypeClass, dictTypeBusCode, dictTypeCode, dictTypeName, dictTypeNamePinyin, dictTypeDesc, statusFlag, dictTypeSort, delFlag, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
