...
package io.entframework.kernel.migration.aggregation.scheduling;
...
public class SchedulingCenter {
	...
	public static void addMigration(AccessMigrationApi accessMigrationApi) {
		...
		// 拼接key值
		String appAndModuleNameItem = accessMigrationApi.getAppName() + MigrationConstants.NAME_SEPARATOR
				+ accessMigrationApi.getModuleName();
