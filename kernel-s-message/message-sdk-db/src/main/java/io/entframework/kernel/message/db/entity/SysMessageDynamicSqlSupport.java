...
public final class SysMessageDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(messageId, receiveUserId, sendUserId,
            messageTitle, messageContent, messageType, priorityLevel, messageSendTime, businessId, businessType,
            readFlag, delFlag, createUser, createTime, updateUser, updateTime, createUserName, updateUserName);
