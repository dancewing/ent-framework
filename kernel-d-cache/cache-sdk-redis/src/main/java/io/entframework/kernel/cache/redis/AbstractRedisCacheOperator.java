	...
	public Collection<String> getAllKeys() {
		...
		if (keys != null) {
			...
			return StreamSupport
					.stream(Spliterators.spliteratorUnknownSize(keys.iterator(), Spliterator.ORDERED), false)
					.map(key -> CharSequenceUtil.removePrefix(key, getPrefix())).collect(Collectors.toSet());
		}
		else {
