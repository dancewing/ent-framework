...
public final class TranslationDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(tranId, tranCode, tranName, tranLanguageCode,
            tranValue, createTime, createUser, updateTime, updateUser, createUserName, updateUserName);
