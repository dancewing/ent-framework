...
public class UserTranslationController {
    ...
    public ResponseData<List<SimpleDict>> getAllLanguages() {
        List<SimpleDict> dictDetailsByDictTypeCode = dictApi
                .getDictDetailsByDictTypeCode(DictConstants.LANGUAGES_DICT_TYPE_CODE);
    ...
    public ResponseData<Map<String, String>> getUserTranslation() {
        ...
        Map<String, String> translationDictByLanguage = TranslationContext.me()
                .getTranslationDictByLanguage(tranLanguageCode);
    ...
    public ResponseData<Void> changeUserTranslation(
