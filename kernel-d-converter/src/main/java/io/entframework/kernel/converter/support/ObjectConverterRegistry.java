...
public interface ObjectConverterRegistry {
	...
	/**
	 * Add a plain converter to this registry. The convertible source/target type pair is
	 * derived from the Converter's parameterized types.
	 ...
	 * <p>
	 * Allows for a Converter to be reused for multiple distinct pairs without having to
