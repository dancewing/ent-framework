...
public class ResourceFactory {
    ...
    public static boolean equals(SysResource source, SysResource that) {
        ...
        return new EqualsBuilder().append(source.getAppCode(), that.getAppCode())
                ...
                .append(source.getClassName(), that.getClassName())
                .append(source.getMethodName(), that.getMethodName())
                .append(source.getModularCode(), that.getModularCode())
                .append(source.getModularName(), that.getModularName())
                .append(source.getViewFlag(), that.getViewFlag())
                .append(source.getUrl(), that.getUrl())
                .append(source.getHttpMethod(), that.getHttpMethod())
                ...
                .append(source.getResponseFieldDescriptions(), that.getResponseFieldDescriptions())
                .isEquals();
    }
