...
public final class SysResourceDynamicSqlSupport {
    ...
    public static final BasicColumn[] selectList = BasicColumn.columnList(resourceId, appCode, resourceCode, resourceName, projectCode, className, methodName, modularCode, modularName, ipAddress, viewFlag, url, httpMethod, requiredLoginFlag, autoReport, requiredPermissionFlag, createUser, createTime, updateUser, updateTime, createUserName, updateUserName, validateGroups, paramFieldDescriptions, responseFieldDescriptions);
    ...
    public static final class SysResource extends AliasableSqlTable<SysResource> {
        ...
        public final SqlColumn<String> paramFieldDescriptions = column("param_field_descriptions", JDBCType.LONGVARCHAR);

        public final SqlColumn<String> responseFieldDescriptions = column("response_field_descriptions", JDBCType.LONGVARCHAR);
